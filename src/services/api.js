...
export async function questionListAll(params) {
  return request(`/lesson/manage/lesson/question/list/new?${stringify(params)}`)
}
...
export async function initCourseware(params) {
  return request(`/lesson/manage/lesson/courseware/history?${stringify(params)}`)
}
...
export async function getHistoryQuesion(params) {
  return request(`/lesson/manage/question/history/questions?${stringify(params)}`)
}
