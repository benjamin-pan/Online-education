...
export const getRouterData = app => {
  ...
  '/manage/home': {
    component: dynamicWrapper(app, [], () => import('../routes/ManageHome')),
    // authority: 'zuwen', // 配置准入权限
  },
  '/lesson/courseware/config': {
    name:"授课事务 / 配置课件",
      component: dynamicWrapper(app, ['lesson'], () => import('../routes/Lesson/CoursewareConfig')),
  },
  '/user/login': {
